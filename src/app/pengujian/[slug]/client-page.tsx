          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2">
              <div 
                ...
                >
                <img
                  src={getImageUrl(test.images[imageIndex].image)}
                  alt={test.name}
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="bg-black/70 text-white px-3 py-1 rounded-full text-sm font-medium">
                    {test.price && formatPrice(test.price)}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    {test.price && <p className="font-medium text-lg">{formatPrice(test.price)}</p>}
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{test.minimum_unit} {test.unit.name}</p>
                  </div>
                </div>
